...
export default function FacebookLoginButton({ label }: { label: string }) {
  ...
  return (
    <a href={`${baseUrl}/auth/login/Facebook`} className="flex items-center justify-center gap-2 py-2.5 border border-stone-200 rounded-full hover:bg-stone-50 transition-colors w-full">
