...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260714204812_SeedRegionsFromExistingCheckpoints")]
    partial class SeedRegionsFromExistingCheckpoints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CheckinRecord", b =>
                {
                    ...
                    b.Property<Guid?>("DollTokenId")
                        .HasColumnType("uuid")
                        .HasColumnName("doll_token_id");
            ...
            modelBuilder.Entity("Domain.Entities.DollToken", b =>
                {
                    ...
                    b.Property<Guid>("DollId")
                        .HasColumnType("uuid")
                        .HasColumnName("doll_id");
                    ...
                    b.HasIndex("DollId")
                        .HasDatabaseName("idx_doll_tokens_doll_id");

                    b.HasIndex("Token")
                        .IsUnique()
                        .HasDatabaseName("idx_doll_tokens_token");

                    b.HasIndex("UserId")
                        .HasDatabaseName("idx_doll_tokens_user_id");

                    b.ToTable("doll_tokens", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.HanoiKnowledge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Category")
                        .HasDatabaseName("idx_hanoi_knowledge_category")
                        .HasFilter("is_active = true");

                    b.HasIndex("Language")
                        .HasDatabaseName("idx_hanoi_knowledge_lang")
                        .HasFilter("is_active = true");

                    b.ToTable("hanoi_knowledge", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Region", b =>
                {
                    ...
                    b.HasIndex("IsActive")
                        .HasDatabaseName("idx_regions_is_active");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("idx_regions_name");

                    b.HasIndex("Slug")
                        .IsUnique()
                        .HasDatabaseName("idx_regions_slug");
            ...
            modelBuilder.Entity("Domain.Entities.UserGamificationProfile", b =>
                {
                    ...
                    b.Property<int>("StampsUnlocked")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("stamps_unlocked");
                    ...
                    b.ToTable("user_gamification_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserStamp", b =>
                {
                    ...
                    b.Property<bool>("HasDollBonus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("has_doll_bonus");
            ...
            modelBuilder.Entity("Domain.Entities.XpTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("idx_xp_transactions_user_id");
            ...
            modelBuilder.Entity("Domain.Entities.Character", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Region", "RegionEntity")
                        .WithMany("Characters")
